...
//	}
	...
	public static ArrayList<String> getKeyWordList(ArrayList<String> sentenceList, String target, String effect) 
	...
	public static String getKeyWord(String sentence, String target, String effect) 
		...
		//if(!(sentence.contains(target) && sentence.contains(effect))){ return ""; }
